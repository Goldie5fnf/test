...
class GrainEffect
{
	...
	public function new (){
		shader = new Grain();
		shader.lumamount.value = [0.0];
		shader.grainsize.value = [0.0];
		shader.lockAlpha.value = [0.0];
	...
	function set_lumamount(value:Float):Float {
	shader.lumamount.value = [value];
        lumamount = value;
        return value;
	}
	function set_grainsize(value:Float):Float {
	shader.grainsize.value = [value];
        grainsize = value;
        return value;
	}
